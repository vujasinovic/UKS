...
urlpatterns = [
    ...
    path('comments/add/issue_<int:issue_id>', views.CommentCreate.as_view(), name='comment_new_log'),
    path('comments/edit/<int:pk>\w{1,20}', views.CommentUpdate.as_view(), name='comment_update'),
